        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="overview-section">
                    ...
                    <h2>How to play:</h2>
                    <p>Two teams of around 15 players each compete. Forwards focus on ball possession, while backs emphasize speed and scoring. Points are scored through tries (5 points), conversions (2 points), penalty kicks (3 points), and drop goals (3 points).</p>
                    <h2>Rules:</h2>
